...
<div class="container">
    ...
    <a href="http://localhost/sistem_absensi/payroll.php" class="button">Create</a>
        ...
        if(!$result){
            ...
            while($row = mysqli_fetch_assoc($result)){
                echo "<tr>
                        ...
                        <td>
                            <a href='http://localhost/sistem_absensi/deletePayroll.php?id=".$row['id']."' class='button'>Delete</a>
                        </td>
                      </tr>";
            }
        }
