...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Ambil data pegawai
    $sqlPegawai = "SELECT * FROM pegawai WHERE id = ?";
    ...
    $sqlJamKerjaIdeal = "SELECT hari_kerja_1_bulan * jam_kerja_1_hari AS jam_kerja_ideal FROM pegawai WHERE id = ?";
    ...
    $sqlInsertDataGaji = "INSERT INTO payroll (id, nama, periode_awal, periode_akhir, total_jam_kerja, gaji, keterangan) 
    VALUES ('$id', '".$pegawai['nama']."', '$startDate', '$endDate', '$totalJamKerja', '$gaji', '$keterangan')";
...
<h1>Form Payroll</h1>
    <form action="payroll.php" method="post">
        ...
        <a href="http://localhost/sistem_absensi/readPayroll.php" class="button">Back</a>
    </form>
